...
[assembly: DbMappingViewCacheTypeAttribute(
    ...
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets12a0fc6cf4d6f2ae97508b9966d15caac628fa78857611a636cc85e55225ace4))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySets12a0fc6cf4d6f2ae97508b9966d15caac628fa78857611a636cc85e55225ace4 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "12a0fc6cf4d6f2ae97508b9966d15caac628fa78857611a636cc85e55225ace4"; }
        }
    ...
    SELECT VALUE -- Constructing AppAudit
        [CodeFirstDatabaseSchema.AppAudit](T1.AppAudit_AuditID, T1.AppAudit_AuditDT, T1.AppAudit_AuditType, T1.AppAudit_AuditSUserSName, T1.[AppAudit.ID_], T1.AppAudit_ITIL, T1.AppAudit_abbr, T1.AppAudit_description, T1.[AppAudit.updateDT_], T1.[AppAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [AppAudit.ID_], 
            T.ITIL AS AppAudit_ITIL, 
            T.abbr AS AppAudit_abbr, 
            T.description AS AppAudit_description, 
            T.updateDT_ AS [AppAudit.updateDT_], 
            T.updateUser_ AS [AppAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView60()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing appAudit
        [Company.DIV.ConfigMgr.Data.Read.AppAudit](T1.AppAudit_AuditID, T1.AppAudit_AuditDT, T1.AppAudit_AuditType, T1.AppAudit_AuditSUserSName, T1.[AppAudit.ID_], T1.AppAudit_ITIL, T1.AppAudit_abbr, T1.AppAudit_description, T1.[AppAudit.updateDT_], T1.[AppAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS AppAudit_AuditID, 
            T.AuditDT AS AppAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing ConfigAudit
        [CodeFirstDatabaseSchema.ConfigAudit](T1.ConfigAudit_AuditID, T1.ConfigAudit_AuditDT, T1.ConfigAudit_AuditType, T1.ConfigAudit_AuditSUserSName, T1.[ConfigAudit.ID_], T1.ConfigAudit_jobID, T1.ConfigAudit_AppID, T1.ConfigAudit_ParamVersionID, T1.ConfigAudit_Active, T1.ConfigAudit_DescriptonShort, T1.ConfigAudit_DescriptonFull, T1.ConfigAudit_effDT, T1.ConfigAudit_trmDT, T1.[ConfigAudit.updateDT_], T1.[ConfigAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.updateDT_ AS [ConfigAudit.updateDT_], 
            T.updateUser_ AS [ConfigAudit.updateUser_], 
            True AS _from0
    ...
    SELECT VALUE -- Constructing ConfigParamDEV1Audit
        [CodeFirstDatabaseSchema.ConfigParamDEV1Audit](T1.ConfigParamDEV1Audit_AuditID, T1.ConfigParamDEV1Audit_AuditDT, T1.ConfigParamDEV1Audit_AuditType, T1.ConfigParamDEV1Audit_AuditSUserSName, T1.[ConfigParamDEV1Audit.ID_], T1.ConfigParamDEV1Audit_ConfigID, T1.ConfigParamDEV1Audit_effDT, T1.ConfigParamDEV1Audit_trmDT, T1.ConfigParamDEV1Audit_ParamDefinitionsID, T1.ConfigParamDEV1Audit_isRefOnly, T1.ConfigParamDEV1Audit_value, T1.ConfigParamDEV1Audit_valueUseageComments, T1.[ConfigParamDEV1Audit.updateDT_], T1.[ConfigParamDEV1Audit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [ConfigParamDEV1Audit.ID_], 
            ...
            T.updateDT_ AS [ConfigParamDEV1Audit.updateDT_], 
            T.updateUser_ AS [ConfigParamDEV1Audit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView64()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamDev1Audit
        [Company.DIV.ConfigMgr.Data.Read.ConfigParamDEV1Audit](T1.ConfigParamDEV1Audit_AuditID, T1.ConfigParamDEV1Audit_AuditDT, T1.ConfigParamDEV1Audit_AuditType, T1.ConfigParamDEV1Audit_AuditSUserSName, T1.[ConfigParamDEV1Audit.ID_], T1.ConfigParamDEV1Audit_ConfigID, T1.ConfigParamDEV1Audit_effDT, T1.ConfigParamDEV1Audit_trmDT, T1.ConfigParamDEV1Audit_ParamDefinitionsID, T1.ConfigParamDEV1Audit_isRefOnly, T1.ConfigParamDEV1Audit_value, T1.ConfigParamDEV1Audit_valueUseageComments, T1.[ConfigParamDEV1Audit.updateDT_], T1.[ConfigParamDEV1Audit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS ConfigParamDEV1Audit_AuditID, 
            T.AuditDT AS ConfigParamDEV1Audit_AuditDT, 
    ...
    SELECT VALUE -- Constructing ConfigParamDEV2Audit
        [CodeFirstDatabaseSchema.ConfigParamDEV2Audit](T1.ConfigParamDEV2Audit_AuditID, T1.ConfigParamDEV2Audit_AuditDT, T1.ConfigParamDEV2Audit_AuditType, T1.ConfigParamDEV2Audit_AuditSUserSName, T1.[ConfigParamDEV2Audit.ID_], T1.ConfigParamDEV2Audit_ConfigID, T1.ConfigParamDEV2Audit_effDT, T1.ConfigParamDEV2Audit_trmDT, T1.ConfigParamDEV2Audit_ParamDefinitionsID, T1.ConfigParamDEV2Audit_isRefOnly, T1.ConfigParamDEV2Audit_value, T1.ConfigParamDEV2Audit_valueUseageComments, T1.[ConfigParamDEV2Audit.updateDT_], T1.[ConfigParamDEV2Audit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [ConfigParamDEV2Audit.ID_], 
            ...
            T.updateDT_ AS [ConfigParamDEV2Audit.updateDT_], 
            T.updateUser_ AS [ConfigParamDEV2Audit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView66()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamDev2Audit
        [Company.DIV.ConfigMgr.Data.Read.ConfigParamDEV2Audit](T1.ConfigParamDEV2Audit_AuditID, T1.ConfigParamDEV2Audit_AuditDT, T1.ConfigParamDEV2Audit_AuditType, T1.ConfigParamDEV2Audit_AuditSUserSName, T1.[ConfigParamDEV2Audit.ID_], T1.ConfigParamDEV2Audit_ConfigID, T1.ConfigParamDEV2Audit_effDT, T1.ConfigParamDEV2Audit_trmDT, T1.ConfigParamDEV2Audit_ParamDefinitionsID, T1.ConfigParamDEV2Audit_isRefOnly, T1.ConfigParamDEV2Audit_value, T1.ConfigParamDEV2Audit_valueUseageComments, T1.[ConfigParamDEV2Audit.updateDT_], T1.[ConfigParamDEV2Audit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS ConfigParamDEV2Audit_AuditID, 
            T.AuditDT AS ConfigParamDEV2Audit_AuditDT, 
    ...
    SELECT VALUE -- Constructing ConfigParamPRODAudit
        [CodeFirstDatabaseSchema.ConfigParamPRODAudit](T1.ConfigParamPRODAudit_AuditID, T1.ConfigParamPRODAudit_AuditDT, T1.ConfigParamPRODAudit_AuditType, T1.ConfigParamPRODAudit_AuditSUserSName, T1.[ConfigParamPRODAudit.ID_], T1.ConfigParamPRODAudit_ConfigID, T1.ConfigParamPRODAudit_effDT, T1.ConfigParamPRODAudit_trmDT, T1.ConfigParamPRODAudit_ParamDefinitionsID, T1.ConfigParamPRODAudit_isRefOnly, T1.ConfigParamPRODAudit_value, T1.ConfigParamPRODAudit_valueUseageComments, T1.[ConfigParamPRODAudit.updateDT_], T1.[ConfigParamPRODAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [ConfigParamPRODAudit.ID_], 
            ...
            T.updateDT_ AS [ConfigParamPRODAudit.updateDT_], 
            T.updateUser_ AS [ConfigParamPRODAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView68()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamPRODAudit
        [Company.DIV.ConfigMgr.Data.Read.ConfigParamPRODAudit](T1.ConfigParamPRODAudit_AuditID, T1.ConfigParamPRODAudit_AuditDT, T1.ConfigParamPRODAudit_AuditType, T1.ConfigParamPRODAudit_AuditSUserSName, T1.[ConfigParamPRODAudit.ID_], T1.ConfigParamPRODAudit_ConfigID, T1.ConfigParamPRODAudit_effDT, T1.ConfigParamPRODAudit_trmDT, T1.ConfigParamPRODAudit_ParamDefinitionsID, T1.ConfigParamPRODAudit_isRefOnly, T1.ConfigParamPRODAudit_value, T1.ConfigParamPRODAudit_valueUseageComments, T1.[ConfigParamPRODAudit.updateDT_], T1.[ConfigParamPRODAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS ConfigParamPRODAudit_AuditID, 
            T.AuditDT AS ConfigParamPRODAudit_AuditDT, 
    ...
    FROM (
        SELECT 
            ...
            T.ID_ AS [ConfigParamQA1Audit.ID_], 
            ...
            T.updateDT_ AS [ConfigParamQA1Audit.updateDT_], 
            T.updateUser_ AS [ConfigParamQA1Audit.updateUser_], 
            True AS _from0
    ...
    SELECT VALUE -- Constructing ConfigParamQA2Audit
        [CodeFirstDatabaseSchema.ConfigParamQA2Audit](T1.ConfigParamQA2Audit_AuditID, T1.ConfigParamQA2Audit_AuditDT, T1.ConfigParamQA2Audit_AuditType, T1.ConfigParamQA2Audit_AuditSUserSName, T1.[ConfigParamQA2Audit.ID_], T1.ConfigParamQA2Audit_ConfigID, T1.ConfigParamQA2Audit_effDT, T1.ConfigParamQA2Audit_trmDT, T1.ConfigParamQA2Audit_ParamDefinitionsID, T1.ConfigParamQA2Audit_isRefOnly, T1.ConfigParamQA2Audit_value, T1.ConfigParamQA2Audit_valueUseageComments, T1.[ConfigParamQA2Audit.updateDT_], T1.[ConfigParamQA2Audit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [ConfigParamQA2Audit.ID_], 
            ...
            T.updateDT_ AS [ConfigParamQA2Audit.updateDT_], 
            T.updateUser_ AS [ConfigParamQA2Audit.updateUser_], 
            True AS _from0
    ...
    SELECT VALUE -- Constructing ConfigParamSTG1Audit
        [CodeFirstDatabaseSchema.ConfigParamSTG1Audit](T1.ConfigParamSTG1Audit_AuditID, T1.ConfigParamSTG1Audit_AuditDT, T1.ConfigParamSTG1Audit_AuditType, T1.ConfigParamSTG1Audit_AuditSUserSName, T1.[ConfigParamSTG1Audit.ID_], T1.ConfigParamSTG1Audit_ConfigID, T1.ConfigParamSTG1Audit_effDT, T1.ConfigParamSTG1Audit_trmDT, T1.ConfigParamSTG1Audit_ParamDefinitionsID, T1.ConfigParamSTG1Audit_isRefOnly, T1.ConfigParamSTG1Audit_value, T1.ConfigParamSTG1Audit_valueUseageComments, T1.[ConfigParamSTG1Audit.updateDT_], T1.[ConfigParamSTG1Audit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [ConfigParamSTG1Audit.ID_], 
            ...
            T.updateDT_ AS [ConfigParamSTG1Audit.updateDT_], 
            T.updateUser_ AS [ConfigParamSTG1Audit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView74()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamSTG1Audit
        [Company.DIV.ConfigMgr.Data.Read.ConfigParamSTG1Audit](T1.ConfigParamSTG1Audit_AuditID, T1.ConfigParamSTG1Audit_AuditDT, T1.ConfigParamSTG1Audit_AuditType, T1.ConfigParamSTG1Audit_AuditSUserSName, T1.[ConfigParamSTG1Audit.ID_], T1.ConfigParamSTG1Audit_ConfigID, T1.ConfigParamSTG1Audit_effDT, T1.ConfigParamSTG1Audit_trmDT, T1.ConfigParamSTG1Audit_ParamDefinitionsID, T1.ConfigParamSTG1Audit_isRefOnly, T1.ConfigParamSTG1Audit_value, T1.ConfigParamSTG1Audit_valueUseageComments, T1.[ConfigParamSTG1Audit.updateDT_], T1.[ConfigParamSTG1Audit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS ConfigParamSTG1Audit_AuditID, 
            T.AuditDT AS ConfigParamSTG1Audit_AuditDT, 
    ...
    SELECT VALUE -- Constructing ConfigParamSTG2Audit
        [CodeFirstDatabaseSchema.ConfigParamSTG2Audit](T1.ConfigParamSTG2Audit_AuditID, T1.ConfigParamSTG2Audit_AuditDT, T1.ConfigParamSTG2Audit_AuditType, T1.ConfigParamSTG2Audit_AuditSUserSName, T1.[ConfigParamSTG2Audit.ID_], T1.ConfigParamSTG2Audit_ConfigID, T1.ConfigParamSTG2Audit_effDT, T1.ConfigParamSTG2Audit_trmDT, T1.ConfigParamSTG2Audit_ParamDefinitionsID, T1.ConfigParamSTG2Audit_isRefOnly, T1.ConfigParamSTG2Audit_value, T1.ConfigParamSTG2Audit_valueUseageComments, T1.[ConfigParamSTG2Audit.updateDT_], T1.[ConfigParamSTG2Audit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [ConfigParamSTG2Audit.ID_], 
            ...
            T.updateDT_ AS [ConfigParamSTG2Audit.updateDT_], 
            T.updateUser_ AS [ConfigParamSTG2Audit.updateUser_], 
            True AS _from0
    ...
    SELECT VALUE -- Constructing ExecutableAudit
        [CodeFirstDatabaseSchema.ExecutableAudit](T1.ExecutableAudit_AuditID, T1.ExecutableAudit_AuditDT, T1.ExecutableAudit_AuditType, T1.ExecutableAudit_AuditSUserSName, T1.[ExecutableAudit.ID_], T1.ExecutableAudit_ParamVersionID, T1.ExecutableAudit_AppID, T1.ExecutableAudit_nameWExtension, T1.ExecutableAudit_description, T1.[ExecutableAudit.updateDT_], T1.[ExecutableAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.updateDT_ AS [ExecutableAudit.updateDT_], 
            T.updateUser_ AS [ExecutableAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView78()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing executableAudit
        [Company.DIV.ConfigMgr.Data.Read.ExecutableAudit](T1.ExecutableAudit_AuditID, T1.ExecutableAudit_AuditDT, T1.ExecutableAudit_AuditType, T1.ExecutableAudit_AuditSUserSName, T1.[ExecutableAudit.ID_], T1.ExecutableAudit_ParamVersionID, T1.ExecutableAudit_AppID, T1.ExecutableAudit_nameWExtension, T1.ExecutableAudit_description, T1.[ExecutableAudit.updateDT_], T1.[ExecutableAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS ExecutableAudit_AuditID, 
            T.AuditDT AS ExecutableAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing PrimaryFunctionAudit
        [CodeFirstDatabaseSchema.PrimaryFunctionAudit](T1.PrimaryFunctionAudit_AuditID, T1.PrimaryFunctionAudit_AuditDT, T1.PrimaryFunctionAudit_AuditType, T1.PrimaryFunctionAudit_AuditSUserSName, T1.[PrimaryFunctionAudit.ID_], T1.PrimaryFunctionAudit_abbr, T1.PrimaryFunctionAudit_description, T1.[PrimaryFunctionAudit.updateDT_], T1.[PrimaryFunctionAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [PrimaryFunctionAudit.ID_], 
            T.abbr AS PrimaryFunctionAudit_abbr, 
            T.description AS PrimaryFunctionAudit_description, 
            T.updateDT_ AS [PrimaryFunctionAudit.updateDT_], 
            T.updateUser_ AS [PrimaryFunctionAudit.updateUser_], 
            True AS _from0
    ...
    SELECT VALUE -- Constructing executableFunctionAudit
        [Company.DIV.ConfigMgr.Data.Read.PrimaryFunctionAudit](T1.PrimaryFunctionAudit_AuditID, T1.PrimaryFunctionAudit_AuditDT, T1.PrimaryFunctionAudit_AuditType, T1.PrimaryFunctionAudit_AuditSUserSName, T1.[PrimaryFunctionAudit.ID_], T1.PrimaryFunctionAudit_abbr, T1.PrimaryFunctionAudit_description, T1.[PrimaryFunctionAudit.updateDT_], T1.[PrimaryFunctionAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS PrimaryFunctionAudit_AuditID, 
            T.AuditDT AS PrimaryFunctionAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing JAppPlanAudit
        [CodeFirstDatabaseSchema.JAppPlanAudit](T1.JAppPlanAudit_AuditID, T1.JAppPlanAudit_AuditDT, T1.JAppPlanAudit_AuditType, T1.JAppPlanAudit_AuditSUserSName, T1.[JAppPlanAudit.ID_], T1.JAppPlanAudit_AppID, T1.JAppPlanAudit_PlanID, T1.[JAppPlanAudit.updateDT_], T1.[JAppPlanAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [JAppPlanAudit.ID_], 
            T.AppID AS JAppPlanAudit_AppID, 
            T.PlanID AS JAppPlanAudit_PlanID, 
            T.updateDT_ AS [JAppPlanAudit.updateDT_], 
            T.updateUser_ AS [JAppPlanAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView82()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing jAppPlanAudit
        [Company.DIV.ConfigMgr.Data.Read.JAppPlanAudit](T1.JAppPlanAudit_AuditID, T1.JAppPlanAudit_AuditDT, T1.JAppPlanAudit_AuditType, T1.JAppPlanAudit_AuditSUserSName, T1.[JAppPlanAudit.ID_], T1.JAppPlanAudit_AppID, T1.JAppPlanAudit_PlanID, T1.[JAppPlanAudit.updateDT_], T1.[JAppPlanAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS JAppPlanAudit_AuditID, 
            T.AuditDT AS JAppPlanAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing JConfigExecutableAudit
        [CodeFirstDatabaseSchema.JConfigExecutableAudit](T1.JConfigExecutableAudit_AuditID, T1.JConfigExecutableAudit_AuditDT, T1.JConfigExecutableAudit_AuditType, T1.JConfigExecutableAudit_AuditSUserSName, T1.[JConfigExecutableAudit.ID_], T1.JConfigExecutableAudit_ConfigID, T1.JConfigExecutableAudit_ExecutableID, T1.[JConfigExecutableAudit.updateDT_], T1.[JConfigExecutableAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [JConfigExecutableAudit.ID_], 
            T.ConfigID AS JConfigExecutableAudit_ConfigID, 
            T.ExecutableID AS JConfigExecutableAudit_ExecutableID, 
            T.updateDT_ AS [JConfigExecutableAudit.updateDT_], 
            T.updateUser_ AS [JConfigExecutableAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView84()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing jConfigExecutableAudit
        [Company.DIV.ConfigMgr.Data.Read.JConfigExecutableAudit](T1.JConfigExecutableAudit_AuditID, T1.JConfigExecutableAudit_AuditDT, T1.JConfigExecutableAudit_AuditType, T1.JConfigExecutableAudit_AuditSUserSName, T1.[JConfigExecutableAudit.ID_], T1.JConfigExecutableAudit_ConfigID, T1.JConfigExecutableAudit_ExecutableID, T1.[JConfigExecutableAudit.updateDT_], T1.[JConfigExecutableAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS JConfigExecutableAudit_AuditID, 
            T.AuditDT AS JConfigExecutableAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing JConfigJPlanLOBAudit
        [CodeFirstDatabaseSchema.JConfigJPlanLOBAudit](T1.JConfigJPlanLOBAudit_AuditID, T1.JConfigJPlanLOBAudit_AuditDT, T1.JConfigJPlanLOBAudit_AuditType, T1.JConfigJPlanLOBAudit_AuditSUserSName, T1.[JConfigJPlanLOBAudit.ID_], T1.JConfigJPlanLOBAudit_ConfigID, T1.JConfigJPlanLOBAudit_JPlanLOBID, T1.[JConfigJPlanLOBAudit.updateDT_], T1.[JConfigJPlanLOBAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [JConfigJPlanLOBAudit.ID_], 
            T.ConfigID AS JConfigJPlanLOBAudit_ConfigID, 
            T.JPlanLOBID AS JConfigJPlanLOBAudit_JPlanLOBID, 
            T.updateDT_ AS [JConfigJPlanLOBAudit.updateDT_], 
            T.updateUser_ AS [JConfigJPlanLOBAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView86()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing jConfigJPlanLOBAudit
        [Company.DIV.ConfigMgr.Data.Read.JConfigJPlanLOBAudit](T1.JConfigJPlanLOBAudit_AuditID, T1.JConfigJPlanLOBAudit_AuditDT, T1.JConfigJPlanLOBAudit_AuditType, T1.JConfigJPlanLOBAudit_AuditSUserSName, T1.[JConfigJPlanLOBAudit.ID_], T1.JConfigJPlanLOBAudit_ConfigID, T1.JConfigJPlanLOBAudit_JPlanLOBID, T1.[JConfigJPlanLOBAudit.updateDT_], T1.[JConfigJPlanLOBAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS JConfigJPlanLOBAudit_AuditID, 
            T.AuditDT AS JConfigJPlanLOBAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing JConfigPlanAudit
        [CodeFirstDatabaseSchema.JConfigPlanAudit](T1.JConfigPlanAudit_AuditID, T1.JConfigPlanAudit_AuditDT, T1.JConfigPlanAudit_AuditType, T1.JConfigPlanAudit_AuditSUserSName, T1.[JConfigPlanAudit.ID_], T1.JConfigPlanAudit_ConfigID, T1.JConfigPlanAudit_PlanID, T1.[JConfigPlanAudit.updateDT_], T1.[JConfigPlanAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [JConfigPlanAudit.ID_], 
            T.ConfigID AS JConfigPlanAudit_ConfigID, 
            T.PlanID AS JConfigPlanAudit_PlanID, 
            T.updateDT_ AS [JConfigPlanAudit.updateDT_], 
            T.updateUser_ AS [JConfigPlanAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView88()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing jConfigPlanAudit
        [Company.DIV.ConfigMgr.Data.Read.JConfigPlanAudit](T1.JConfigPlanAudit_AuditID, T1.JConfigPlanAudit_AuditDT, T1.JConfigPlanAudit_AuditType, T1.JConfigPlanAudit_AuditSUserSName, T1.[JConfigPlanAudit.ID_], T1.JConfigPlanAudit_ConfigID, T1.JConfigPlanAudit_PlanID, T1.[JConfigPlanAudit.updateDT_], T1.[JConfigPlanAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS JConfigPlanAudit_AuditID, 
            T.AuditDT AS JConfigPlanAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing JExecutablePathServerAudit
        [CodeFirstDatabaseSchema.JExecutablePathServerAudit](T1.JExecutablePathServerAudit_AuditID, T1.JExecutablePathServerAudit_AuditDT, T1.JExecutablePathServerAudit_AuditType, T1.JExecutablePathServerAudit_AuditSUserSName, T1.[JExecutablePathServerAudit.ID_], T1.JExecutablePathServerAudit_ExecutableID, T1.JExecutablePathServerAudit_PathServerID, T1.[JExecutablePathServerAudit.updateDT_], T1.[JExecutablePathServerAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [JExecutablePathServerAudit.ID_], 
            T.ExecutableID AS JExecutablePathServerAudit_ExecutableID, 
            T.PathServerID AS JExecutablePathServerAudit_PathServerID, 
            T.updateDT_ AS [JExecutablePathServerAudit.updateDT_], 
            T.updateUser_ AS [JExecutablePathServerAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView90()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing jExecutablePathServerAudit
        [Company.DIV.ConfigMgr.Data.Read.JExecutablePathServerAudit](T1.JExecutablePathServerAudit_AuditID, T1.JExecutablePathServerAudit_AuditDT, T1.JExecutablePathServerAudit_AuditType, T1.JExecutablePathServerAudit_AuditSUserSName, T1.[JExecutablePathServerAudit.ID_], T1.JExecutablePathServerAudit_ExecutableID, T1.JExecutablePathServerAudit_PathServerID, T1.[JExecutablePathServerAudit.updateDT_], T1.[JExecutablePathServerAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS JExecutablePathServerAudit_AuditID, 
            T.AuditDT AS JExecutablePathServerAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing JExecutablePrimaryFunctionAudit
        [CodeFirstDatabaseSchema.JExecutablePrimaryFunctionAudit](T1.JExecutablePrimaryFunctionAudit_AuditID, T1.JExecutablePrimaryFunctionAudit_AuditDT, T1.JExecutablePrimaryFunctionAudit_AuditType, T1.JExecutablePrimaryFunctionAudit_AuditSUserSName, T1.[JExecutablePrimaryFunctionAudit.ID_], T1.JExecutablePrimaryFunctionAudit_ExecutableID, T1.JExecutablePrimaryFunctionAudit_PrimaryFunctionID, T1.[JExecutablePrimaryFunctionAudit.updateDT_], T1.[JExecutablePrimaryFunctionAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [JExecutablePrimaryFunctionAudit.ID_], 
            ...
            T.updateDT_ AS [JExecutablePrimaryFunctionAudit.updateDT_], 
            T.updateUser_ AS [JExecutablePrimaryFunctionAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView92()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing jExecutablePrimaryFunctionAudit
        [Company.DIV.ConfigMgr.Data.Read.JExecutablePrimaryFunctionAudit](T1.JExecutablePrimaryFunctionAudit_AuditID, T1.JExecutablePrimaryFunctionAudit_AuditDT, T1.JExecutablePrimaryFunctionAudit_AuditType, T1.JExecutablePrimaryFunctionAudit_AuditSUserSName, T1.[JExecutablePrimaryFunctionAudit.ID_], T1.JExecutablePrimaryFunctionAudit_ExecutableID, T1.JExecutablePrimaryFunctionAudit_PrimaryFunctionID, T1.[JExecutablePrimaryFunctionAudit.updateDT_], T1.[JExecutablePrimaryFunctionAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS JExecutablePrimaryFunctionAudit_AuditID, 
            T.AuditDT AS JExecutablePrimaryFunctionAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing JPathServerPathShareAudit
        [CodeFirstDatabaseSchema.JPathServerPathShareAudit](T1.JPathServerPathShareAudit_AuditID, T1.JPathServerPathShareAudit_AuditDT, T1.JPathServerPathShareAudit_AuditType, T1.JPathServerPathShareAudit_AuditSUserSName, T1.[JPathServerPathShareAudit.ID_], T1.JPathServerPathShareAudit_PathServerID, T1.JPathServerPathShareAudit_PathShareID, T1.[JPathServerPathShareAudit.updateDT_], T1.[JPathServerPathShareAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [JPathServerPathShareAudit.ID_], 
            T.PathServerID AS JPathServerPathShareAudit_PathServerID, 
            T.PathShareID AS JPathServerPathShareAudit_PathShareID, 
            T.updateDT_ AS [JPathServerPathShareAudit.updateDT_], 
            T.updateUser_ AS [JPathServerPathShareAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView94()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing jPathServerPathShareAudit
        [Company.DIV.ConfigMgr.Data.Read.JPathServerPathShareAudit](T1.JPathServerPathShareAudit_AuditID, T1.JPathServerPathShareAudit_AuditDT, T1.JPathServerPathShareAudit_AuditType, T1.JPathServerPathShareAudit_AuditSUserSName, T1.[JPathServerPathShareAudit.ID_], T1.JPathServerPathShareAudit_PathServerID, T1.JPathServerPathShareAudit_PathShareID, T1.[JPathServerPathShareAudit.updateDT_], T1.[JPathServerPathShareAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS JPathServerPathShareAudit_AuditID, 
            T.AuditDT AS JPathServerPathShareAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing JPlanLOBAudit
        [CodeFirstDatabaseSchema.JPlanLOBAudit](T1.JPlanLOBAudit_AuditID, T1.JPlanLOBAudit_AuditDT, T1.JPlanLOBAudit_AuditType, T1.JPlanLOBAudit_AuditSUserSName, T1.[JPlanLOBAudit.ID_], T1.JPlanLOBAudit_planID, T1.JPlanLOBAudit_LineOfBusinessID, T1.[JPlanLOBAudit.updateDT_], T1.[JPlanLOBAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [JPlanLOBAudit.ID_], 
            T.planID AS JPlanLOBAudit_planID, 
            T.LineOfBusinessID AS JPlanLOBAudit_LineOfBusinessID, 
            T.updateDT_ AS [JPlanLOBAudit.updateDT_], 
            T.updateUser_ AS [JPlanLOBAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView96()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing jPlanLOBAudit
        [Company.DIV.ConfigMgr.Data.Read.JPlanLOBAudit](T1.JPlanLOBAudit_AuditID, T1.JPlanLOBAudit_AuditDT, T1.JPlanLOBAudit_AuditType, T1.JPlanLOBAudit_AuditSUserSName, T1.[JPlanLOBAudit.ID_], T1.JPlanLOBAudit_planID, T1.JPlanLOBAudit_LineOfBusinessID, T1.[JPlanLOBAudit.updateDT_], T1.[JPlanLOBAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS JPlanLOBAudit_AuditID, 
            T.AuditDT AS JPlanLOBAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing LineOfBusinessAudit
        [CodeFirstDatabaseSchema.LineOfBusinessAudit](T1.LineOfBusinessAudit_AuditID, T1.LineOfBusinessAudit_AuditDT, T1.LineOfBusinessAudit_AuditType, T1.LineOfBusinessAudit_AuditSUserSName, T1.[LineOfBusinessAudit.ID_], T1.LineOfBusinessAudit_abbr, T1.LineOfBusinessAudit_descr, T1.[LineOfBusinessAudit.updateDT_], T1.[LineOfBusinessAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [LineOfBusinessAudit.ID_], 
            T.abbr AS LineOfBusinessAudit_abbr, 
            T.descr AS LineOfBusinessAudit_descr, 
            T.updateDT_ AS [LineOfBusinessAudit.updateDT_], 
            T.updateUser_ AS [LineOfBusinessAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView98()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing lineOfBusinessAudit
        [Company.DIV.ConfigMgr.Data.Read.LineOfBusinessAudit](T1.LineOfBusinessAudit_AuditID, T1.LineOfBusinessAudit_AuditDT, T1.LineOfBusinessAudit_AuditType, T1.LineOfBusinessAudit_AuditSUserSName, T1.[LineOfBusinessAudit.ID_], T1.LineOfBusinessAudit_abbr, T1.LineOfBusinessAudit_descr, T1.[LineOfBusinessAudit.updateDT_], T1.[LineOfBusinessAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS LineOfBusinessAudit_AuditID, 
            T.AuditDT AS LineOfBusinessAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing ParamDefinitionAudit
        [CodeFirstDatabaseSchema.ParamDefinitionAudit](T1.ParamDefinitionAudit_AuditID, T1.ParamDefinitionAudit_AuditDT, T1.ParamDefinitionAudit_AuditType, T1.ParamDefinitionAudit_AuditSUserSName, T1.[ParamDefinitionAudit.ID_], T1.ParamDefinitionAudit_ParamVersionID, T1.ParamDefinitionAudit_ParamSequence, T1.ParamDefinitionAudit_ParamTypeID, T1.ParamDefinitionAudit_variableName, T1.ParamDefinitionAudit_intendedUse, T1.[ParamDefinitionAudit.updateDT_], T1.[ParamDefinitionAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [ParamDefinitionAudit.ID_], 
            ...
            T.updateDT_ AS [ParamDefinitionAudit.updateDT_], 
            T.updateUser_ AS [ParamDefinitionAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView100()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing paramDefinitionAudit
        [Company.DIV.ConfigMgr.Data.Read.ParamDefinitionAudit](T1.ParamDefinitionAudit_AuditID, T1.ParamDefinitionAudit_AuditDT, T1.ParamDefinitionAudit_AuditType, T1.ParamDefinitionAudit_AuditSUserSName, T1.[ParamDefinitionAudit.ID_], T1.ParamDefinitionAudit_ParamVersionID, T1.ParamDefinitionAudit_ParamSequence, T1.ParamDefinitionAudit_ParamTypeID, T1.ParamDefinitionAudit_variableName, T1.ParamDefinitionAudit_intendedUse, T1.[ParamDefinitionAudit.updateDT_], T1.[ParamDefinitionAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS ParamDefinitionAudit_AuditID, 
            T.AuditDT AS ParamDefinitionAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing ParamTypeAudit
        [CodeFirstDatabaseSchema.ParamTypeAudit](T1.ParamTypeAudit_AuditID, T1.ParamTypeAudit_AuditDT, T1.ParamTypeAudit_AuditType, T1.ParamTypeAudit_AuditSUserSName, T1.[ParamTypeAudit.ID_], T1.ParamTypeAudit_type, T1.[ParamTypeAudit.updateDT_], T1.[ParamTypeAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [ParamTypeAudit.ID_], 
            T.type AS ParamTypeAudit_type, 
            T.updateDT_ AS [ParamTypeAudit.updateDT_], 
            T.updateUser_ AS [ParamTypeAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView102()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing paramTypeAudit
        [Company.DIV.ConfigMgr.Data.Read.ParamTypeAudit](T1.ParamTypeAudit_AuditID, T1.ParamTypeAudit_AuditDT, T1.ParamTypeAudit_AuditType, T1.ParamTypeAudit_AuditSUserSName, T1.[ParamTypeAudit.ID_], T1.ParamTypeAudit_type, T1.[ParamTypeAudit.updateDT_], T1.[ParamTypeAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS ParamTypeAudit_AuditID, 
            T.AuditDT AS ParamTypeAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing ParamVersionAudit
        [CodeFirstDatabaseSchema.ParamVersionAudit](T1.ParamVersionAudit_AuditID, T1.ParamVersionAudit_AuditDT, T1.ParamVersionAudit_AuditType, T1.ParamVersionAudit_AuditSUserSName, T1.[ParamVersionAudit.ID_], T1.ParamVersionAudit_version, T1.ParamVersionAudit_description, T1.[ParamVersionAudit.updateDT_], T1.[ParamVersionAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [ParamVersionAudit.ID_], 
            T.version AS ParamVersionAudit_version, 
            T.description AS ParamVersionAudit_description, 
            T.updateDT_ AS [ParamVersionAudit.updateDT_], 
            T.updateUser_ AS [ParamVersionAudit.updateUser_], 
            True AS _from0
    ...
    SELECT VALUE -- Constructing PathServerAudit
        [CodeFirstDatabaseSchema.PathServerAudit](T1.PathServerAudit_AuditID, T1.PathServerAudit_AuditDT, T1.PathServerAudit_AuditType, T1.PathServerAudit_AuditSUserSName, T1.[PathServerAudit.ID_], T1.PathServerAudit_server, T1.PathServerAudit_path, T1.[PathServerAudit.updateDT_], T1.[PathServerAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [PathServerAudit.ID_], 
            T.server AS PathServerAudit_server, 
            T.path AS PathServerAudit_path, 
            T.updateDT_ AS [PathServerAudit.updateDT_], 
            T.updateUser_ AS [PathServerAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView106()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing pathServerAudit
        [Company.DIV.ConfigMgr.Data.Read.PathServerAudit](T1.PathServerAudit_AuditID, T1.PathServerAudit_AuditDT, T1.PathServerAudit_AuditType, T1.PathServerAudit_AuditSUserSName, T1.[PathServerAudit.ID_], T1.PathServerAudit_server, T1.PathServerAudit_path, T1.[PathServerAudit.updateDT_], T1.[PathServerAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS PathServerAudit_AuditID, 
            T.AuditDT AS PathServerAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing PathShareAudit
        [CodeFirstDatabaseSchema.PathShareAudit](T1.PathShareAudit_AuditID, T1.PathShareAudit_AuditDT, T1.PathShareAudit_AuditType, T1.PathShareAudit_AuditSUserSName, T1.[PathShareAudit.ID_], T1.PathShareAudit_share, T1.PathShareAudit_path, T1.[PathShareAudit.updateDT_], T1.[PathShareAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [PathShareAudit.ID_], 
            T.share AS PathShareAudit_share, 
            T.path AS PathShareAudit_path, 
            T.updateDT_ AS [PathShareAudit.updateDT_], 
            T.updateUser_ AS [PathShareAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView108()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing pathShareAudit
        [Company.DIV.ConfigMgr.Data.Read.PathShareAudit](T1.PathShareAudit_AuditID, T1.PathShareAudit_AuditDT, T1.PathShareAudit_AuditType, T1.PathShareAudit_AuditSUserSName, T1.[PathShareAudit.ID_], T1.PathShareAudit_share, T1.PathShareAudit_path, T1.[PathShareAudit.updateDT_], T1.[PathShareAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS PathShareAudit_AuditID, 
            T.AuditDT AS PathShareAudit_AuditDT, 
    ...
    SELECT VALUE -- Constructing PlanAudit
        [CodeFirstDatabaseSchema.PlanAudit](T1.PlanAudit_AuditID, T1.PlanAudit_AuditDT, T1.PlanAudit_AuditType, T1.PlanAudit_AuditSUserSName, T1.[PlanAudit.ID_], T1.PlanAudit_abbr, T1.PlanAudit_descr, T1.[PlanAudit.updateDT_], T1.[PlanAudit.updateUser_])
    FROM (
        SELECT 
            ...
            T.ID_ AS [PlanAudit.ID_], 
            T.abbr AS PlanAudit_abbr, 
            T.descr AS PlanAudit_descr, 
            T.updateDT_ AS [PlanAudit.updateDT_], 
            T.updateUser_ AS [PlanAudit.updateUser_], 
            True AS _from0
        ...
        private static DbMappingView GetView110()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing planAudit
        [Company.DIV.ConfigMgr.Data.Read.PlanAudit](T1.PlanAudit_AuditID, T1.PlanAudit_AuditDT, T1.PlanAudit_AuditType, T1.PlanAudit_AuditSUserSName, T1.[PlanAudit.ID_], T1.PlanAudit_abbr, T1.PlanAudit_descr, T1.[PlanAudit.updateDT_], T1.[PlanAudit.updateUser_])
    FROM (
        SELECT 
            T.AuditID AS PlanAudit_AuditID, 
            T.AuditDT AS PlanAudit_AuditDT, 
