...
//without abstract on ConfigParams - but not sure if built before generating!?
//------------------------------------------------------------------------------
...
[assembly: DbMappingViewCacheTypeAttribute(
    ...
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets37711fd5fa7536423e8396dea259d919c25cdcedfeffe992624f200f39928836))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySets37711fd5fa7536423e8396dea259d919c25cdcedfeffe992624f200f39928836 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "37711fd5fa7536423e8396dea259d919c25cdcedfeffe992624f200f39928836"; }
        }
    ...
    SELECT VALUE -- Constructing ConfigParams
        CASE
            WHEN (NOT(T9._from1) AND NOT(T9._from2) AND NOT(T9._from3) AND NOT(T9._from4) AND NOT(T9._from5) AND NOT(T9._from6) AND NOT(T9._from7)) THEN [MVC02.Models.ConfigParam](T9.ConfigParam_ID, T9.ConfigParam_ConfigID, T9.ConfigParam_effDT, T9.ConfigParam_trmDT, T9.ConfigParam_ParamDefinitionsID, T9.ConfigParam_isRefOnly, T9.ConfigParam_value, T9.ConfigParam_valueUseageComments, T9.ConfigParam_createDT, T9.ConfigParam_createUser, T9.ConfigParam_updateDT, T9.ConfigParam_updateUser) WITH 
                RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T9.[ParamDefinition_ConfigParams.ParamDefinition_ConfigParams_Source.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ParamDefinition_ConfigParams],ParamDefinition_ConfigParams_Target,ParamDefinition_ConfigParams_Source) 
            WHEN T9._from1 THEN [MVC02.Models.ConfigParamDEV1](T9.ConfigParam_ID, T9.ConfigParam_ConfigID, T9.ConfigParam_effDT, T9.ConfigParam_trmDT, T9.ConfigParam_ParamDefinitionsID, T9.ConfigParam_isRefOnly, T9.ConfigParam_value, T9.ConfigParam_valueUseageComments, T9.ConfigParam_createDT, T9.ConfigParam_createUser, T9.ConfigParam_updateDT, T9.ConfigParam_updateUser) WITH 
                RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T9.[ParamDefinition_ConfigParams.ParamDefinition_ConfigParams_Source.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ParamDefinition_ConfigParams],ParamDefinition_ConfigParams_Target,ParamDefinition_ConfigParams_Source) 
            WHEN T9._from2 THEN [MVC02.Models.ConfigParamDEV2](T9.ConfigParam_ID, T9.ConfigParam_ConfigID, T9.ConfigParam_effDT, T9.ConfigParam_trmDT, T9.ConfigParam_ParamDefinitionsID, T9.ConfigParam_isRefOnly, T9.ConfigParam_value, T9.ConfigParam_valueUseageComments, T9.ConfigParam_createDT, T9.ConfigParam_createUser, T9.ConfigParam_updateDT, T9.ConfigParam_updateUser) WITH 
                RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T9.[ParamDefinition_ConfigParams.ParamDefinition_ConfigParams_Source.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ParamDefinition_ConfigParams],ParamDefinition_ConfigParams_Target,ParamDefinition_ConfigParams_Source) 
            WHEN T9._from3 THEN [MVC02.Models.ConfigParamPROD](T9.ConfigParam_ID, T9.ConfigParam_ConfigID, T9.ConfigParam_effDT, T9.ConfigParam_trmDT, T9.ConfigParam_ParamDefinitionsID, T9.ConfigParam_isRefOnly, T9.ConfigParam_value, T9.ConfigParam_valueUseageComments, T9.ConfigParam_createDT, T9.ConfigParam_createUser, T9.ConfigParam_updateDT, T9.ConfigParam_updateUser) WITH 
                RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T9.[ParamDefinition_ConfigParams.ParamDefinition_ConfigParams_Source.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ParamDefinition_ConfigParams],ParamDefinition_ConfigParams_Target,ParamDefinition_ConfigParams_Source) 
            WHEN T9._from4 THEN [MVC02.Models.ConfigParamQA1](T9.ConfigParam_ID, T9.ConfigParam_ConfigID, T9.ConfigParam_effDT, T9.ConfigParam_trmDT, T9.ConfigParam_ParamDefinitionsID, T9.ConfigParam_isRefOnly, T9.ConfigParam_value, T9.ConfigParam_valueUseageComments, T9.ConfigParam_createDT, T9.ConfigParam_createUser, T9.ConfigParam_updateDT, T9.ConfigParam_updateUser) WITH 
                RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T9.[ParamDefinition_ConfigParams.ParamDefinition_ConfigParams_Source.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ParamDefinition_ConfigParams],ParamDefinition_ConfigParams_Target,ParamDefinition_ConfigParams_Source) 
            WHEN T9._from5 THEN [MVC02.Models.ConfigParamQA2](T9.ConfigParam_ID, T9.ConfigParam_ConfigID, T9.ConfigParam_effDT, T9.ConfigParam_trmDT, T9.ConfigParam_ParamDefinitionsID, T9.ConfigParam_isRefOnly, T9.ConfigParam_value, T9.ConfigParam_valueUseageComments, T9.ConfigParam_createDT, T9.ConfigParam_createUser, T9.ConfigParam_updateDT, T9.ConfigParam_updateUser) WITH 
                RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T9.[ParamDefinition_ConfigParams.ParamDefinition_ConfigParams_Source.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ParamDefinition_ConfigParams],ParamDefinition_ConfigParams_Target,ParamDefinition_ConfigParams_Source) 
            WHEN T9._from6 THEN [MVC02.Models.ConfigParamSTG1](T9.ConfigParam_ID, T9.ConfigParam_ConfigID, T9.ConfigParam_effDT, T9.ConfigParam_trmDT, T9.ConfigParam_ParamDefinitionsID, T9.ConfigParam_isRefOnly, T9.ConfigParam_value, T9.ConfigParam_valueUseageComments, T9.ConfigParam_createDT, T9.ConfigParam_createUser, T9.ConfigParam_updateDT, T9.ConfigParam_updateUser) WITH 
                RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T9.[ParamDefinition_ConfigParams.ParamDefinition_ConfigParams_Source.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ParamDefinition_ConfigParams],ParamDefinition_ConfigParams_Target,ParamDefinition_ConfigParams_Source) 
            ELSE [MVC02.Models.ConfigParamSTG2](T9.ConfigParam_ID, T9.ConfigParam_ConfigID, T9.ConfigParam_effDT, T9.ConfigParam_trmDT, T9.ConfigParam_ParamDefinitionsID, T9.ConfigParam_isRefOnly, T9.ConfigParam_value, T9.ConfigParam_valueUseageComments, T9.ConfigParam_createDT, T9.ConfigParam_createUser, T9.ConfigParam_updateDT, T9.ConfigParam_updateUser) WITH 
                RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T9.[ParamDefinition_ConfigParams.ParamDefinition_ConfigParams_Source.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ParamDefinition_ConfigParams],ParamDefinition_ConfigParams_Target,ParamDefinition_ConfigParams_Source) 
        END
    FROM (
        SELECT T1.ConfigParam_ID, T1.ConfigParam_ConfigID, T1.ConfigParam_effDT, T1.ConfigParam_trmDT, T1.ConfigParam_ParamDefinitionsID, T1.ConfigParam_isRefOnly, T1.ConfigParam_value, T1.ConfigParam_valueUseageComments, T1.ConfigParam_createDT, T1.ConfigParam_createUser, T1.ConfigParam_updateDT, T1.ConfigParam_updateUser, T1._from0, (T2._from1 AND T2._from1 IS NOT NULL) AS _from1, (T4._from2 AND T4._from2 IS NOT NULL) AS _from2, (T5._from3 AND T5._from3 IS NOT NULL) AS _from3, (T6._from4 AND T6._from4 IS NOT NULL) AS _from4, (T7._from5 AND T7._from5 IS NOT NULL) AS _from5, (T8._from6 AND T8._from6 IS NOT NULL) AS _from6, (T3._from7 AND T3._from7 IS NOT NULL) AS _from7, T1.[ParamDefinition_ConfigParams.ParamDefinition_ConfigParams_Source.ID]
        FROM  (
            SELECT 
                T.ID AS ConfigParam_ID, 
                T.ConfigID AS ConfigParam_ConfigID, 
            ...
            FROM CodeFirstDatabase.ConfigParam AS T) AS T1
            LEFT OUTER JOIN (
            SELECT 
                T.ID AS ConfigParam_ID, 
                True AS _from1
            FROM CodeFirstDatabase.ConfigParam1 AS T) AS T2
            ON T1.ConfigParam_ID = T2.ConfigParam_ID
            LEFT OUTER JOIN (
            SELECT 
                T.ID AS ConfigParam_ID, 
                True AS _from7
            FROM CodeFirstDatabase.ConfigParam7 AS T) AS T3
            ON T1.ConfigParam_ID = T3.ConfigParam_ID
            LEFT OUTER JOIN (
            SELECT 
                T.ID AS ConfigParam_ID, 
                True AS _from2
            FROM CodeFirstDatabase.ConfigParam5 AS T) AS T4
            ON T1.ConfigParam_ID = T4.ConfigParam_ID
            LEFT OUTER JOIN (
            SELECT 
                T.ID AS ConfigParam_ID, 
                True AS _from3
            FROM CodeFirstDatabase.ConfigParam2 AS T) AS T5
            ON T1.ConfigParam_ID = T5.ConfigParam_ID
            LEFT OUTER JOIN (
            SELECT 
                T.ID AS ConfigParam_ID, 
                True AS _from4
            FROM CodeFirstDatabase.ConfigParam3 AS T) AS T6
            ON T1.ConfigParam_ID = T6.ConfigParam_ID
            LEFT OUTER JOIN (
            SELECT 
                T.ID AS ConfigParam_ID, 
                True AS _from5
            FROM CodeFirstDatabase.ConfigParam6 AS T) AS T7
            ON T1.ConfigParam_ID = T7.ConfigParam_ID
            LEFT OUTER JOIN (
            SELECT 
                T.ID AS ConfigParam_ID, 
                True AS _from6
            FROM CodeFirstDatabase.ConfigParam4 AS T) AS T8
            ON T1.ConfigParam_ID = T8.ConfigParam_ID
    ) AS T9");
        }
