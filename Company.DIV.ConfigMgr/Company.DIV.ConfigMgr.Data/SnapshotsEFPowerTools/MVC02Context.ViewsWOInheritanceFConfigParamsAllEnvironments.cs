...
[assembly: DbMappingViewCacheTypeAttribute(
    ...
    typeof(Edm_EntityMappingGeneratedViews.ViewsForBaseEntitySets290d423469bda2e5365e3cb5cfb71c2e6feb219ee230111079a77bba5a5fd730))]
...
namespace Edm_EntityMappingGeneratedViews
{
    ...
    internal sealed class ViewsForBaseEntitySets290d423469bda2e5365e3cb5cfb71c2e6feb219ee230111079a77bba5a5fd730 : DbMappingViewCache
    {
        /// <summary>
        ...
        {
            get { return "290d423469bda2e5365e3cb5cfb71c2e6feb219ee230111079a77bba5a5fd730"; }
        }
        ...
        public override DbMappingView GetView(EntitySetBase extent)
        {
            ...
            if (extentName == "MVC02Context.configParamDev1")
            {
                return GetView28();
            }

            if (extentName == "MVC02Context.ConfigParamDEV1_ParamDefinition")
            {
                return GetView29();
            }
            ...
            if (extentName == "MVC02Context.configParamDev2")
            {
                return GetView31();
            }

            if (extentName == "MVC02Context.ConfigParamDEV2_ParamDefinition")
            {
                return GetView32();
            }

            if (extentName == "MVC02Context.configParamPROD")
            {
                return GetView33();
            }

            if (extentName == "MVC02Context.ConfigParamPROD_ParamDefinition")
            {
                return GetView34();
            }

            if (extentName == "MVC02Context.configParamQA1")
            {
                return GetView35();
            }

            if (extentName == "MVC02Context.ConfigParamQA1_ParamDefinition")
            {
                return GetView36();
            }

            if (extentName == "MVC02Context.configParamQA2")
            {
                return GetView37();
            }

            if (extentName == "MVC02Context.ConfigParamQA2_ParamDefinition")
            {
                return GetView38();
            }

            if (extentName == "MVC02Context.configParamSTG1")
            {
                return GetView39();
            }

            if (extentName == "MVC02Context.ConfigParamSTG1_ParamDefinition")
            {
                return GetView40();
            }

            if (extentName == "MVC02Context.configParamSTG2")
            {
                return GetView41();
            }

            if (extentName == "MVC02Context.ConfigParamSTG2_ParamDefinition")
            {
                return GetView42();
            }
    ...
    FROM (
        ...
        FROM  (
            SELECT 
                ...
                True AS _from1
            FROM MVC02Context.ConfigParamDEV1_ParamDefinition AS T) AS T1
            INNER JOIN (
            SELECT 
                ...
                True AS _from0
            FROM MVC02Context.configParamDev1 AS T) AS T2
    ...
    FROM (
        ...
        FROM  (
            SELECT 
                ...
                True AS _from1
            FROM MVC02Context.ConfigParamDEV2_ParamDefinition AS T) AS T1
            INNER JOIN (
            SELECT 
                ...
                True AS _from0
            FROM MVC02Context.configParamDev2 AS T) AS T2
    ...
    FROM (
        ...
        FROM  (
            SELECT 
                ...
                True AS _from1
            FROM MVC02Context.ConfigParamPROD_ParamDefinition AS T) AS T1
            INNER JOIN (
            SELECT 
                ...
                True AS _from0
            FROM MVC02Context.configParamPROD AS T) AS T2
    ...
    FROM (
        ...
        FROM  (
            SELECT 
                ...
                True AS _from1
            FROM MVC02Context.ConfigParamQA1_ParamDefinition AS T) AS T1
            INNER JOIN (
            SELECT 
                ...
                True AS _from0
            FROM MVC02Context.configParamQA1 AS T) AS T2
    ...
    FROM (
        ...
        FROM  (
            SELECT 
                ...
                True AS _from1
            FROM MVC02Context.ConfigParamQA2_ParamDefinition AS T) AS T1
            INNER JOIN (
            SELECT 
                ...
                True AS _from0
            FROM MVC02Context.configParamQA2 AS T) AS T2
    ...
    FROM (
        ...
        FROM  (
            SELECT 
                ...
                True AS _from1
            FROM MVC02Context.ConfigParamSTG1_ParamDefinition AS T) AS T1
            INNER JOIN (
            SELECT 
                ...
                True AS _from0
            FROM MVC02Context.configParamSTG1 AS T) AS T2
    ...
    FROM (
        ...
        FROM  (
            SELECT 
                ...
                True AS _from1
            FROM MVC02Context.ConfigParamSTG2_ParamDefinition AS T) AS T1
            INNER JOIN (
            SELECT 
                ...
                True AS _from0
            FROM MVC02Context.configParamSTG2 AS T) AS T2
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for MVC02Context.configParamDev1.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView28()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamDev1
        [MVC02.Models.ConfigParamDEV1](T1.ConfigParamDEV1_ID, T1.ConfigParamDEV1_ConfigID, T1.ConfigParamDEV1_effDT, T1.ConfigParamDEV1_trmDT, T1.ConfigParamDEV1_ParamDefinitionsID, T1.ConfigParamDEV1_isRefOnly, T1.ConfigParamDEV1_value, T1.ConfigParamDEV1_valueUseageComments, T1.ConfigParamDEV1_createDT, T1.ConfigParamDEV1_createUser, T1.ConfigParamDEV1_updateDT, T1.ConfigParamDEV1_updateUser) WITH 
        RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T1.[ConfigParamDEV1_ParamDefinition.ConfigParamDEV1_ParamDefinition_Target.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ConfigParamDEV1_ParamDefinition],ConfigParamDEV1_ParamDefinition_Source,ConfigParamDEV1_ParamDefinition_Target) 
    FROM (
        SELECT 
            T.ID AS ConfigParamDEV1_ID, 
            T.ConfigID AS ConfigParamDEV1_ConfigID, 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.ConfigParamDEV1_ParamDefinition.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing ConfigParamDEV1_ParamDefinition
        [MVC02.Models.ConfigParamDEV1_ParamDefinition](T3.[ConfigParamDEV1_ParamDefinition.ConfigParamDEV1_ParamDefinition_Source], T3.[ConfigParamDEV1_ParamDefinition.ConfigParamDEV1_ParamDefinition_Target])
    FROM (
        SELECT -- Constructing ConfigParamDEV1_ParamDefinition_Source
            CreateRef(MVC02Context.configParamDev1, row(T2.[ConfigParamDEV1_ParamDefinition.ConfigParamDEV1_ParamDefinition_Source.ID]), [MVC02.Models.ConfigParamDEV1]) AS [ConfigParamDEV1_ParamDefinition.ConfigParamDEV1_ParamDefinition_Source], 
        ...
        FROM (
            SELECT -- Constructing ConfigParamDEV1_ParamDefinition_Target
                ...
                CreateRef(MVC02Context.paramDefinitions, row(T1.[ConfigParamDEV1_ParamDefinition.ConfigParamDEV1_ParamDefinition_Target.ID]), [MVC02.Models.ParamDefinition]) AS [ConfigParamDEV1_ParamDefinition.ConfigParamDEV1_ParamDefinition_Target]
            FROM (
                SELECT 
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for MVC02Context.configParamDev2.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView31()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamDev2
        [MVC02.Models.ConfigParamDEV2](T1.ConfigParamDEV2_ID, T1.ConfigParamDEV2_ConfigID, T1.ConfigParamDEV2_effDT, T1.ConfigParamDEV2_trmDT, T1.ConfigParamDEV2_ParamDefinitionsID, T1.ConfigParamDEV2_isRefOnly, T1.ConfigParamDEV2_value, T1.ConfigParamDEV2_valueUseageComments, T1.ConfigParamDEV2_createDT, T1.ConfigParamDEV2_createUser, T1.ConfigParamDEV2_updateDT, T1.ConfigParamDEV2_updateUser) WITH 
        RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T1.[ConfigParamDEV2_ParamDefinition.ConfigParamDEV2_ParamDefinition_Target.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ConfigParamDEV2_ParamDefinition],ConfigParamDEV2_ParamDefinition_Source,ConfigParamDEV2_ParamDefinition_Target) 
    FROM (
        SELECT 
            T.ID AS ConfigParamDEV2_ID, 
            T.ConfigID AS ConfigParamDEV2_ConfigID, 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.ConfigParamDEV2_ParamDefinition.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing ConfigParamDEV2_ParamDefinition
        [MVC02.Models.ConfigParamDEV2_ParamDefinition](T3.[ConfigParamDEV2_ParamDefinition.ConfigParamDEV2_ParamDefinition_Source], T3.[ConfigParamDEV2_ParamDefinition.ConfigParamDEV2_ParamDefinition_Target])
    FROM (
        SELECT -- Constructing ConfigParamDEV2_ParamDefinition_Source
            CreateRef(MVC02Context.configParamDev2, row(T2.[ConfigParamDEV2_ParamDefinition.ConfigParamDEV2_ParamDefinition_Source.ID]), [MVC02.Models.ConfigParamDEV2]) AS [ConfigParamDEV2_ParamDefinition.ConfigParamDEV2_ParamDefinition_Source], 
        ...
        FROM (
            SELECT -- Constructing ConfigParamDEV2_ParamDefinition_Target
                ...
                CreateRef(MVC02Context.paramDefinitions, row(T1.[ConfigParamDEV2_ParamDefinition.ConfigParamDEV2_ParamDefinition_Target.ID]), [MVC02.Models.ParamDefinition]) AS [ConfigParamDEV2_ParamDefinition.ConfigParamDEV2_ParamDefinition_Target]
            FROM (
                SELECT 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.configParamPROD.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView33()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamPROD
        [MVC02.Models.ConfigParamPROD](T1.ConfigParamPROD_ID, T1.ConfigParamPROD_ConfigID, T1.ConfigParamPROD_effDT, T1.ConfigParamPROD_trmDT, T1.ConfigParamPROD_ParamDefinitionsID, T1.ConfigParamPROD_isRefOnly, T1.ConfigParamPROD_value, T1.ConfigParamPROD_valueUseageComments, T1.ConfigParamPROD_createDT, T1.ConfigParamPROD_createUser, T1.ConfigParamPROD_updateDT, T1.ConfigParamPROD_updateUser) WITH 
        RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T1.[ConfigParamPROD_ParamDefinition.ConfigParamPROD_ParamDefinition_Target.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ConfigParamPROD_ParamDefinition],ConfigParamPROD_ParamDefinition_Source,ConfigParamPROD_ParamDefinition_Target) 
    FROM (
        SELECT 
            T.ID AS ConfigParamPROD_ID, 
            T.ConfigID AS ConfigParamPROD_ConfigID, 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.ConfigParamPROD_ParamDefinition.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing ConfigParamPROD_ParamDefinition
        [MVC02.Models.ConfigParamPROD_ParamDefinition](T3.[ConfigParamPROD_ParamDefinition.ConfigParamPROD_ParamDefinition_Source], T3.[ConfigParamPROD_ParamDefinition.ConfigParamPROD_ParamDefinition_Target])
    FROM (
        SELECT -- Constructing ConfigParamPROD_ParamDefinition_Source
            CreateRef(MVC02Context.configParamPROD, row(T2.[ConfigParamPROD_ParamDefinition.ConfigParamPROD_ParamDefinition_Source.ID]), [MVC02.Models.ConfigParamPROD]) AS [ConfigParamPROD_ParamDefinition.ConfigParamPROD_ParamDefinition_Source], 
        ...
        FROM (
            SELECT -- Constructing ConfigParamPROD_ParamDefinition_Target
                ...
                CreateRef(MVC02Context.paramDefinitions, row(T1.[ConfigParamPROD_ParamDefinition.ConfigParamPROD_ParamDefinition_Target.ID]), [MVC02.Models.ParamDefinition]) AS [ConfigParamPROD_ParamDefinition.ConfigParamPROD_ParamDefinition_Target]
            FROM (
                SELECT 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.configParamQA1.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    FROM (
        ...
        /// <summary>
        /// Gets the view for MVC02Context.ConfigParamQA1_ParamDefinition.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing ConfigParamQA1_ParamDefinition
        [MVC02.Models.ConfigParamQA1_ParamDefinition](T3.[ConfigParamQA1_ParamDefinition.ConfigParamQA1_ParamDefinition_Source], T3.[ConfigParamQA1_ParamDefinition.ConfigParamQA1_ParamDefinition_Target])
    FROM (
        SELECT -- Constructing ConfigParamQA1_ParamDefinition_Source
            CreateRef(MVC02Context.configParamQA1, row(T2.[ConfigParamQA1_ParamDefinition.ConfigParamQA1_ParamDefinition_Source.ID]), [MVC02.Models.ConfigParamQA1]) AS [ConfigParamQA1_ParamDefinition.ConfigParamQA1_ParamDefinition_Source], 
        ...
        FROM (
            SELECT -- Constructing ConfigParamQA1_ParamDefinition_Target
                ...
                CreateRef(MVC02Context.paramDefinitions, row(T1.[ConfigParamQA1_ParamDefinition.ConfigParamQA1_ParamDefinition_Target.ID]), [MVC02.Models.ParamDefinition]) AS [ConfigParamQA1_ParamDefinition.ConfigParamQA1_ParamDefinition_Target]
            FROM (
                SELECT 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.configParamQA2.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView37()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamQA2
        [MVC02.Models.ConfigParamQA2](T1.ConfigParamQA2_ID, T1.ConfigParamQA2_ConfigID, T1.ConfigParamQA2_effDT, T1.ConfigParamQA2_trmDT, T1.ConfigParamQA2_ParamDefinitionsID, T1.ConfigParamQA2_isRefOnly, T1.ConfigParamQA2_value, T1.ConfigParamQA2_valueUseageComments, T1.ConfigParamQA2_createDT, T1.ConfigParamQA2_createUser, T1.ConfigParamQA2_updateDT, T1.ConfigParamQA2_updateUser) WITH 
        RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T1.[ConfigParamQA2_ParamDefinition.ConfigParamQA2_ParamDefinition_Target.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ConfigParamQA2_ParamDefinition],ConfigParamQA2_ParamDefinition_Source,ConfigParamQA2_ParamDefinition_Target) 
    FROM (
        SELECT 
            T.ID AS ConfigParamQA2_ID, 
            T.ConfigID AS ConfigParamQA2_ConfigID, 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.ConfigParamQA2_ParamDefinition.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing ConfigParamQA2_ParamDefinition
        [MVC02.Models.ConfigParamQA2_ParamDefinition](T3.[ConfigParamQA2_ParamDefinition.ConfigParamQA2_ParamDefinition_Source], T3.[ConfigParamQA2_ParamDefinition.ConfigParamQA2_ParamDefinition_Target])
    FROM (
        SELECT -- Constructing ConfigParamQA2_ParamDefinition_Source
            CreateRef(MVC02Context.configParamQA2, row(T2.[ConfigParamQA2_ParamDefinition.ConfigParamQA2_ParamDefinition_Source.ID]), [MVC02.Models.ConfigParamQA2]) AS [ConfigParamQA2_ParamDefinition.ConfigParamQA2_ParamDefinition_Source], 
        ...
        FROM (
            SELECT -- Constructing ConfigParamQA2_ParamDefinition_Target
                ...
                CreateRef(MVC02Context.paramDefinitions, row(T1.[ConfigParamQA2_ParamDefinition.ConfigParamQA2_ParamDefinition_Target.ID]), [MVC02.Models.ParamDefinition]) AS [ConfigParamQA2_ParamDefinition.ConfigParamQA2_ParamDefinition_Target]
            FROM (
                SELECT 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.configParamSTG1.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView39()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamSTG1
        [MVC02.Models.ConfigParamSTG1](T1.ConfigParamSTG1_ID, T1.ConfigParamSTG1_ConfigID, T1.ConfigParamSTG1_effDT, T1.ConfigParamSTG1_trmDT, T1.ConfigParamSTG1_ParamDefinitionsID, T1.ConfigParamSTG1_isRefOnly, T1.ConfigParamSTG1_value, T1.ConfigParamSTG1_valueUseageComments, T1.ConfigParamSTG1_createDT, T1.ConfigParamSTG1_createUser, T1.ConfigParamSTG1_updateDT, T1.ConfigParamSTG1_updateUser) WITH 
        RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T1.[ConfigParamSTG1_ParamDefinition.ConfigParamSTG1_ParamDefinition_Target.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ConfigParamSTG1_ParamDefinition],ConfigParamSTG1_ParamDefinition_Source,ConfigParamSTG1_ParamDefinition_Target) 
    FROM (
        SELECT 
            T.ID AS ConfigParamSTG1_ID, 
            T.ConfigID AS ConfigParamSTG1_ConfigID, 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.ConfigParamSTG1_ParamDefinition.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing ConfigParamSTG1_ParamDefinition
        [MVC02.Models.ConfigParamSTG1_ParamDefinition](T3.[ConfigParamSTG1_ParamDefinition.ConfigParamSTG1_ParamDefinition_Source], T3.[ConfigParamSTG1_ParamDefinition.ConfigParamSTG1_ParamDefinition_Target])
    FROM (
        SELECT -- Constructing ConfigParamSTG1_ParamDefinition_Source
            CreateRef(MVC02Context.configParamSTG1, row(T2.[ConfigParamSTG1_ParamDefinition.ConfigParamSTG1_ParamDefinition_Source.ID]), [MVC02.Models.ConfigParamSTG1]) AS [ConfigParamSTG1_ParamDefinition.ConfigParamSTG1_ParamDefinition_Source], 
        ...
        FROM (
            SELECT -- Constructing ConfigParamSTG1_ParamDefinition_Target
                ...
                CreateRef(MVC02Context.paramDefinitions, row(T1.[ConfigParamSTG1_ParamDefinition.ConfigParamSTG1_ParamDefinition_Target.ID]), [MVC02.Models.ParamDefinition]) AS [ConfigParamSTG1_ParamDefinition.ConfigParamSTG1_ParamDefinition_Target]
            FROM (
                SELECT 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.configParamSTG2.
        /// </summary>
        /// <returns>The mapping view.</returns>
        private static DbMappingView GetView41()
        {
            return new DbMappingView(@"
    SELECT VALUE -- Constructing configParamSTG2
        [MVC02.Models.ConfigParamSTG2](T1.ConfigParamSTG2_ID, T1.ConfigParamSTG2_ConfigID, T1.ConfigParamSTG2_effDT, T1.ConfigParamSTG2_trmDT, T1.ConfigParamSTG2_ParamDefinitionsID, T1.ConfigParamSTG2_isRefOnly, T1.ConfigParamSTG2_value, T1.ConfigParamSTG2_valueUseageComments, T1.ConfigParamSTG2_createDT, T1.ConfigParamSTG2_createUser, T1.ConfigParamSTG2_updateDT, T1.ConfigParamSTG2_updateUser) WITH 
        RELATIONSHIP(CREATEREF(MVC02Context.paramDefinitions, ROW(T1.[ConfigParamSTG2_ParamDefinition.ConfigParamSTG2_ParamDefinition_Target.ID]),[MVC02.Models.ParamDefinition]),[MVC02.Models.ConfigParamSTG2_ParamDefinition],ConfigParamSTG2_ParamDefinition_Source,ConfigParamSTG2_ParamDefinition_Target) 
    FROM (
        SELECT 
            T.ID AS ConfigParamSTG2_ID, 
            T.ConfigID AS ConfigParamSTG2_ConfigID, 
        ...
        /// <summary>
        /// Gets the view for MVC02Context.ConfigParamSTG2_ParamDefinition.
        /// </summary>
        /// <returns>The mapping view.</returns>
    ...
    SELECT VALUE -- Constructing ConfigParamSTG2_ParamDefinition
        [MVC02.Models.ConfigParamSTG2_ParamDefinition](T3.[ConfigParamSTG2_ParamDefinition.ConfigParamSTG2_ParamDefinition_Source], T3.[ConfigParamSTG2_ParamDefinition.ConfigParamSTG2_ParamDefinition_Target])
    FROM (
        SELECT -- Constructing ConfigParamSTG2_ParamDefinition_Source
            CreateRef(MVC02Context.configParamSTG2, row(T2.[ConfigParamSTG2_ParamDefinition.ConfigParamSTG2_ParamDefinition_Source.ID]), [MVC02.Models.ConfigParamSTG2]) AS [ConfigParamSTG2_ParamDefinition.ConfigParamSTG2_ParamDefinition_Source], 
        ...
        FROM (
            SELECT -- Constructing ConfigParamSTG2_ParamDefinition_Target
                ...
                CreateRef(MVC02Context.paramDefinitions, row(T1.[ConfigParamSTG2_ParamDefinition.ConfigParamSTG2_ParamDefinition_Target.ID]), [MVC02.Models.ParamDefinition]) AS [ConfigParamSTG2_ParamDefinition.ConfigParamSTG2_ParamDefinition_Target]
            FROM (
                SELECT 
